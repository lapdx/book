...
class ContactsForm extends Model {
    ...
    public function rules() {
        return [
            [['name', 'email', 'content','address','phone'], 'required', 'message' => '{attribute} không được để trống!'],
    ...
    public function save() {
        ...
        return new Response(true, "Thông tin của bạn đã được gửi. Chúng tôi sẽ liên hệ với bạn trong thời gian sớm nhất", $contact);
    }
