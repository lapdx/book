            ...
            <table id="mytable" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr class="success" >
                        ...
                        <th class="text-center" style="vertical-align: middle;" >Footer</th>
                ...
                <tbody rel-data="bodydata">
                    ...
                    <tr rel-data="<%= this.id %>">
                        ...
                        <td class="text-center" style="vertical-align: middle">
                            <div data-key-footer="<%= this.id %>">
                                <%= '<label class="label label-' + (this.footer == 1 ? 'success' : 'danger') + '" >' + (this.footer == 1 ? 'Hiển thị' : 'Tạm khóa') + '</label>' %>
                            </div>
                        </td>
                        <td class="text-center" style="vertical-align: middle">
                            <div class="btn-group">
