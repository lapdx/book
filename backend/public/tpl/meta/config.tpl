<form class="form-horizontal" id="form-config" style="width: 500px; margin-top: 15px;" >
    ...
    <input name="type" type="hidden" value="<%= (typeof type != 'undefined' ?  type : '') %>" class="form-control" placeholder="ID"/>
    <input name="objectId" type="hidden" value="<%= (typeof objectId != 'undefined' ?  objectId : '') %>" class="form-control" placeholder="ID"/>
    <div class="form-group">
