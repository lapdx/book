(function () {
    ...
    this.ajax = function (params) {
        ...
        params = $.extend({
            url: Fly.baseUrl + "service" + params.service,
            dataType: 'json',
    ...
    this.ajaxUpload = function (params) {
        ...
        var action = Fly.baseUrl + "service" + params.service;
    ...
    this.editor = function (id, options) {
        ...
        setTimeout(function () {
            CKEDITOR.basePath = Fly.baseUrl + 'js/lib/ckeditor/';
            CKEDITOR.plugins.basePath = Fly.baseUrl + 'js/lib/ckeditor/plugins/';
